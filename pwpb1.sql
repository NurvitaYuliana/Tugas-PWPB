...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 22 Bulan Mei 2022 pada 12.54
...
ALTER TABLE `tbl_murid`
  ADD KEY `no_id` (`no_id`,`kd_kelas`,`kd_jur`),
...
--
ALTER TABLE `tbl_murid`
  ADD CONSTRAINT `tbl_murid_ibfk_1` FOREIGN KEY (`no_id`) REFERENCES `tbl-siswa` (`no_id`) ON DELETE CASCADE ON UPDATE CASCADE,
